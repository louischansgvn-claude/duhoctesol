...
/**
 * Học bổng dựng sẵn: ĐÃ XOÁ ngày 21/09/2026.
 *
 * 7 mục cũ (principal-50, global-excellence, international-merit, future-leaders,
 * stem-30, early-bird-ca, turkiye-pathway) là dữ liệu mẫu của bản mockup. Tên
 * chương trình, giá trị và deadline đều tự đặt, không tra được ở trường nào; thân
 * bài còn ghi thẳng "đơn vị cấp học bổng cần xác nhận". Trang công khai lại kèm nút
 * "Ứng tuyển học bổng" nên người đọc hiểu đây là học bổng có thật.
 *
 * Học bổng thật nhập ở wp-admin (CPT `scholarship`) rồi vào site qua
 * duy_scholarship_cpt_cards(). Giữ hàm trả mảng rỗng để mọi lời gọi cũ vẫn chạy.
 */
...
/**
 * Cặp video học viên - trường: ĐÃ XOÁ ngày 21/09/2026.
 *
 * 3 mục cũ (tuong-van, thao-vy-video, khuong-duy) là lời chứng thực bịa: tên người
 * cụ thể, trường thật, kết quả "Học bổng 100%" / "Học bổng tiến sĩ 100%" — không có
 * học viên nào như vậy và cũng không có video kèm theo.
 */
...
/**
 * Câu chuyện học sinh: ĐÃ XOÁ ngày 21/09/2026 - cùng lý do duy_demo_pairs().
 *
 * 4 mục cũ (minh-anh, quoc-bao, thao-vy, an-nhien) dùng chung một đoạn hành trình,
 * ảnh stock của theme và trích dẫn tự viết.
 */
